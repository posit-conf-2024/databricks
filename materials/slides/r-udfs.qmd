...
![](assets/r-udfs/r-udfs.png){.absolute top="260" left="50" width="1800"}

:::{.columns}
:::{.column width="14%"}
:::
:::{.column width="80%"}
[`sparklyr` packages R code inside a Python script]{style="font-size:54px;line-height:1;font-weight:400;color:#666;"}
:::
:::
