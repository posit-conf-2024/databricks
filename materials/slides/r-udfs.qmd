...
## [What is a UDF?]{style="color:#666;"} {background-image="assets/background/slide-light.svg" background-size="1700px" background-color="white"}

:::{.custom}
:::{.incremental1}
- Stands for **"User Defined Function"**
- Enables operations not built-in Spark
- Typically written in a "foreign" language (R, Python)
:::
:::
...
## [Input/Output of a job]{style="color:#666;"} {background-image="assets/background/slide-light.svg" background-size="1700px" background-color="white"}
...
:::
:::{.column width="80%"}
[Your function should expect, and return, a table]{style="font-size:58px;line-height:1;font-weight:400;color:#666;"}
:::
:::
...
:::: {style="text-align: left; float:left;"}
[
You can create a custom R function to send to Spark.<br/><br/>
For your function, assume that the first argument will be a data frame.<br/><br/>
Return an R object that can be coerced to a data frame. 
]{style="color:#666; font-weight:500;font-size:52px;"} 
...
#> # Source:   table<`sparklyr_tmp_table_96595391`> [?? x 3]
#> # Database: spark_connection
#>      mpg   cyl   new
#>    <dbl> <dbl> <dbl>
#>  1  21       6     8
...
![](assets/r-udfs/python-udfs.png){.absolute top="240" left="50" width="1800"}
...
![](assets/r-udfs/r-udfs.png){.absolute top="250" left="50" width="1800"}
