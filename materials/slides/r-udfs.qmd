...
[
`spark_apply()` enables acces to the R runtime installed in the cluster  <br/><br/>
The R function will run over each individual partition. In this case, 4 partitions
of 8 rows each.
