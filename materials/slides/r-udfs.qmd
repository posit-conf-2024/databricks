...
## [Keep in mind...]{style="color:#666;"} {background-image="assets/background/slide-light.svg" background-size="1700px" background-color="white"}
...
- R version can be different, but could be source of errors (*"works locally, but not in the cluster"*)
