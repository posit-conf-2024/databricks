...
## [Specify mulit-choice]{style="color:#666;"} {background-image="assets/background/slide-light.svg" background-size="1700px" background-color="white"}

:::{.columns}
:::{.column width="35%"}
:::{.custom2}
:::{.incremental1}
- Multi-choice arguments require an `ARRAY`
- This can be called directly inside the `ai` function
:::
:::
:::
:::{.column width="65%"}
