...
![](assets/02/object-model.png){.absolute top="280" left="300"}
...
![](assets/02/uc-default1.png){.absolute top="280" left="800" width="850"}
...
![](assets/02/uc-default2.png){.absolute top="280" left="800" width="850"}
...
![](assets/02/uc-customer.png){.absolute top="210" left="820" width="820"}
