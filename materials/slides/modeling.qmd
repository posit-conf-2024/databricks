...
[Create a function that reads the model file, runs predictions, and process results]{style="font-size:46px;line-height:2;font-weight:600;color:#579297;"}
...
my_function <- function(x) {
  library(workflows)
  library(vetiver)
  model <- readRDS("/Volumes/[catalog]/[volume]/model.rds")
