...
![](assets/diagrams/edgar.png){.absolute top="230" left="100" width="500"}
![](assets/diagrams/james.png){.absolute top="230" left="820" width="500"}
...
## Using RStudio {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}

:::{.push}
In the *"Connections"* pane, select *"New Connection"*
:::

![](assets/diagrams/connection-1.png){.absolute top="200" left="200" width="1000"}
...
![](assets/diagrams/connection-2.png){.absolute top="170" left="350" width="700"}
...
![](assets/diagrams/connection-3.png){.absolute top="170" left="350" width="700"}

## RStudio DB Navigator {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}

:::{.push}
Explore the catalogs, schema and tables
:::

![](assets/diagrams/connection-4.png){.absolute top="180" left="250" width="900"}
...
## Connecting {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}

:::{.incremental}
:::{.push}
- `odbc::odbc()` - Needs all required arguments to be passed to the connection **(Good)**
- `odbc::databricks()` - Sets "sensible" defaults to arguments not passed to the connection **(Better)**
- Data Source Name (DSN) - A named connection that is set within the machine **(Best)**
:::
:::
...
## How everything connects {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}

![](assets/diagrams/odbc.png){.absolute top="100" left="80" width="1300"}

## Drivers and DSNs {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}

:::{.push}
- **Database drivers** - Operating system specific application used to connect and
interact with the database. Use `odbcListDrivers()` to see what is installed in your machine
- **DSN** - Use `odbcListDataSources()` to see the database connections pre-set in your machine
:::
...
## Using DBI  {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}
...
- `dbGetQuery()` - Main function, runs the query & collects results
:::
...
## Takeaways {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}
...
## Approaches {background-image="assets/background/slide.png" background-size="1500px" background-color="white"}
