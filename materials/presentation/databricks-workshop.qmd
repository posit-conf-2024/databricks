...
:::{.custom2}
- `dplyr` creates a "virtual" table in R
- It can be used just like a regular data frame
:::
...
<br/>
Source:   SQL [1 x 1]<br/>
Database: Spark SQL 3.1.1[token@Spark SQL/hive_metastore]<br/>
[XX]{style="color: #fff;"}        n<br/>
1      32<br/>
...
- `dplyr` creates a "virtual" table in R
- It can be used just like a regular data frame
- Behind the scenes, `dbplyr` translates R code to SQL
:::
