...
## [Why dashboards?]{style="color:#666;"} {background-image="assets/background/slide.png" background-size="1700px" background-color="white"}
...
## [Important features]{style="color:#666;"} {background-image="assets/background/slide.png" background-size="1700px" background-color="white"}
