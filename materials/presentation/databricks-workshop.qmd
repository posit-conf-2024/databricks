...
:::{.custom2}
Please, please, please...never pass a full query to `tbl()`
:::
...
:::{.column width="85%"}
[
tbl(con, "Select * from 'table'")
]{style="font-size: 100px;font-family:Helvetica Neue; font-weight:150;"}
:::
:::
...
[
tbl(con, "Select * from 'table'")
]{style="text-decoration: line-through; font-size: 100px;font-family:Helvetica Neue; font-weight:150;"}
:::
:::
