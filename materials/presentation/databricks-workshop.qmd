...
## [Some advice...]{style="color:#666;"} {background-image="assets/background/slide.png" background-size="1700px" background-color="white"}

<br/><br/>

:::{.custom2}
1. Use `collect()`, and `pull()`, only if absolutely needed
1. Use `select()` to download only necessary fields
1. Do **not** pass a full SQL statement to `tbl()`
:::
